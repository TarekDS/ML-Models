...
r = 0.2 # ratio of test data over all dacan be changed to any number between 0.0 and 1.0 (not inclusive)
dataset = np.genfromtxt (r'C:\Users\T\Desktop\Python\Data science Uwash/TariqAyub-Dataset.csv', delimiter=",")
...
dataset = np.genfromtxt (r'C:\Users\T\Desktop\Python\Data science Uwash/iris.csv', delimiter=",")
